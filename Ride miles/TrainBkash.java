...
public class TrainBkash extends JFrame implements ActionListener
{
	...
	public TrainBkash()
	{
		...
		p1userLabel1 = new JLabel("Amount : 720 TK");
	...
	public void actionPerformed(ActionEvent e3)
	{
		...
		else if(p1BackBtn.getText().equals(command))
		{
			...
			{ 
					...
					if(s1.equals(ca1.accountNumber) && s2.equals(ca1.password) && ca1.balance1>=720)
					{
			...
			{ 
					...
					if(s1.equals(ca2.accountNumber) && s2.equals(ca2.password) && ca2.balance2>=720)
					{
						showMessageDialog(null, "Payment Successful.");
						TCS c1 = new TCS();
						c1.setVisible(true);
			...
			{ 
					...
					if(s1.equals(ca3.accountNumber) && s2.equals(ca3.password) && ca3.balance3>=720)
					{
						showMessageDialog(null, "Payment Successful.");
						TCS c1 = new TCS();
						c1.setVisible(true);
